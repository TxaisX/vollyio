...
const DIR = "C:/Users/XiongT/.claude/jobs/2d345c50/tmp/hit1/send";
const TIMES = [0.8, 1.4, 1.9, 2.2, 2.4, 2.6, 2.8, 3.3];
...
await writeFile(path.join(ROOT, "ab", "hit1-ringed.jpg"), ringedBuf);
