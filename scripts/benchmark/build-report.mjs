...
const reportPath = path.join(root, "sideout-attacker-model-effort-report.html");
...
<title>Sideout attacker coaching benchmark</title>
<style>
...
<body>
<div class="topbar"><div class="shell"><div class="brand"><span>sideout</span> / coaching benchmark</div><nav><a href="#recommendation">Recommendation</a><a href="#cost">Cost</a><a href="#evidence">Evidence</a><a href="#ranking">Ranking</a><a href="#analysis">Analysis</a><a href="#responses">Responses</a></nav></div></div>
