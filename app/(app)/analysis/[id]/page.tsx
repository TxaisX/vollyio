...
export default async function AnalysisDetail({
  ...
  // A video-path row (D-096) cites no frames, so nothing is highlighted and the
  // filmstrip renders plain. Both fields are absent there rather than empty.
  ...
  // them directly (D-096). Count whichever this row actually has.
  const strengthCount =
